...
import 'package:firebase_ornek/home_page.dart';
  ...
  void _signInWithGoogle() async {
    try {
      ...
      Scaffold.of(context).showSnackBar(
        SnackBar(
          content:
              Text("Hoşgeldin, ${user.displayName}, Google ile giriş yaptı."),
        ),
      );
              ...
              TextFormField(
                ...
                validator: (String mail) {
                  if (mail.trim().isEmpty)
                    return "Lütfen bir mail yazın"; //trim, başındaki veya sonundaki boşlukları boşlukları görmez
                  return null;
                },
              ),
              //? Şifre
