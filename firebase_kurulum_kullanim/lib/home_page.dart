...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            builder: (context) => IconButton(
              ...
              onPressed: () async {
                ...
                Navigator.pushReplacement(
                  //pushreplacement çıkış yapıldığında bir sayfanın üstüne yazar. bir geri bastığında yeniden giriş yapıyormuş gibi olmaz veya giriş yapmamızı istemez
                  context,
                  MaterialPageRoute(
      ...
      body: Container(
        child: StreamBuilder(
          //StreamBuilder, koleksiyonu sürekli dinler extra değişik yapmamıza gerek kalmaz
          stream: FirebaseFirestore.instance
              .collection("collectionPath")
              .snapshots(), // query.snapshots(), //dinleyeceğimiz koleksiyon yolunu tanımlamamız gerekir.
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      leading: documentSnapshot.data()['image'] == null
          ? SizedBox
              .shrink() //shrink image yoksa hata vermesin diye boş bırakması için yazıldı.
